...
def update_user(
    ...
    # v2.2.0 — Phase 6 : si is_active passe à False, enregistrer la date
    # pour invalider rétroactivement les tokens JWT émis avant désactivation.
    if update_data.get("is_active") is False and row.last_disabled_at is None:
        from app.core.datetime import utcnow
        row.last_disabled_at = utcnow()
        audit_payload["last_disabled_at"] = "[SET]"
