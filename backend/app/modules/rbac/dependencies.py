...
def require_permission(permission_code: str):
    ...
    v2.8.0 — SECURITY FIX : le bypass ADMIN est RETIRÉ.
    Seul SUPER_ADMIN conserve un bypass complet (rôle national souverain).
    ADMIN doit désormais avoir les permissions explicites dans
    ROLE_PERMISSION_MAP (seed.py), comme tous les autres rôles.
    ...
    def checker(
        ...
        # v2.8.0 — Seul SUPER_ADMIN bypass (rôle national souverain)
