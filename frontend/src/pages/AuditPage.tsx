    ...
    return (
      <div className="page-container">
        <div className="card" style={{ padding: "32px", textAlign: "center" }}>
          ...
          <h2>Accès refusé</h2>
          <p className="muted">Seuls les administrateurs peuvent consulter le journal d'audit.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-container">
      <div className="page-header" style={{ marginBottom: "24px" }}>
        ...
        <p className="muted">
          Traçabilité complète des actions sensibles — {total} entrée{total > 1 ? "s" : ""} au total
        </p>
      </div>
          ...
          <tbody>
            {loading && (
              <tr><td colSpan={6} style={{ padding: "32px", textAlign: "center", color: "#94a3b8" }}>
                <Activity size={20} style={{ animation: "spin 1s linear infinite", display: "inline-block" }} /> Chargement…
              </td></tr>
            )}
      ...
      {selectedLog && (
        ...
        >
          ...
          >
            <h2 style={{ marginBottom: "16px" }}>Détail de l'entrée d'audit</h2>
