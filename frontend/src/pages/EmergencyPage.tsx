...
const TABS: { key: TabKey; label: string; icon: React.ReactNode }[] = [
  { key: "tableau", label: "emergency.tab.dashboard", icon: <LayoutDashboard size={16} /> },
  { key: "triage", label: "emergency.tab.triage", icon: <ClipboardList size={16} /> },
  { key: "orientation", label: "emergency.tab.orientation", icon: <ArrowRightLeft size={16} /> },
];
  ...
  return (
    <section style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      >
        ...
        <StatCard
          icon={<Clock size={20} />}
          label={t("emergency.stat.waiting")}
          value={stats.waiting}
          color="#b45309"
          bgColor="#fef3c7"
        />
        <StatCard
          ...
          label={t("emergency.stat.triaged")}
          value={stats.triaged}
          color="var(--accent)"
        ...
        <StatCard
          ...
          label={t("emergency.stat.in_care")}
          value={stats.inCare}
          color="#047857"
          bgColor="#d1fae5"
        />
        <StatCard
          ...
          label={t("emergency.stat.oriented")}
        ...
        <StatCard
          ...
          label={t("emergency.stat.critical")}
