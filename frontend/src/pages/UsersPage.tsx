    ...
    <div className="page-container">
      <div className="page-header">
        <div>
          ...
          <p className="muted">Création et gestion des comptes utilisateurs</p>
        </div>
      ...
      <div className="filters-bar" style={{ display: "flex", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
        ...
        <button className="btn btn-secondary" onClick={load}>Filtrer</button>
      </div>
      ...
      <div className="card">
        <table className="table">
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan={isSuperAdmin ? 6 : 5} style={{ textAlign: "center", padding: 24 }}>Chargement...</td></tr>
            ) : users.length === 0 ? (
              <tr><td colSpan={isSuperAdmin ? 6 : 5} style={{ textAlign: "center", padding: 24 }}>Aucun utilisateur</td></tr>
            ) : (
              users.map((u) => (
                <tr key={u.id}>
